...
class _ItemOrderResultPageState extends State<ItemOrderResultPage> {
  ...
  String generateOrderNumber() {
    ...
    String orderNo = "${dateTime.year}${dateTime.month}${dateTime.day} - ${dateTime.hour}${dateTime.minute}${dateTime.millisecond}";
    return orderNo;
  }
          ...
          child: Column(
            children: [
              Container(
                ...
                child: const Text("주문이 완료되었습니다."),
              ),
              if(widget.paymentMethod == '무통장입금')
                Container(
                  padding: const EdgeInsets.all(8),
                  child: const Text("아래 계좌 정보로 입그해주시면 됩니다."),
                ),
              Container(
    ...
    return Container(
      ...
      child: const Row(
        ...
        children: [
          ...
          Expanded(
            flex: 6,
            child: Text("123-1423412-42-151234 (국민은행)"),
          ),
        ],
      ),
    );
